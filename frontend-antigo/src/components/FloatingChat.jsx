        ...
        <div className="bg-white border-b border-gray-200 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">Pré-vendas · Inbound</p>
            </div>
          </div>
          <button
    ...
    return (
      <div className="fixed bottom-6 right-6 z-50">
        ...
        >
          ...
          <span className="font-medium">Lídia - Pré-vendas</span>
          {messages.length > 1 && (
      ...
      <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-purple-100">Pré-vendas · Inbound</p>
          </div>
        </div>
